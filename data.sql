...
insert into cars(make, model, productionyear, gearbox, carengine, description, picture)
values ('Rimac', 'Concept One', '2017', 'Two independent two-speed, Two independent single-speed', 'Electric', 'Car that Richard Hammond almost died in', LOAD_FILE('C:/Projects/TryGor/Pictures/Concept-One.png');
